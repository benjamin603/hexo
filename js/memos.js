...
var memosData = {
  ...
  var memoDefaultList = [
    {
      ...
      "website": "https://snbing.com",
      "link": "https://memos.snbing.com",
      "creatorId": "1",
      "avatar": "https://pic.snbing.com/2024/65bb7cef27431.webp",
      "twikoo": "https://tk.snbing.com",
      "artSite": "东评西就"
    },{
      creatorName:'林木木',
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    if(typeof memosJson !== 'undefined'){
      ...
      try {
        memoList = await getMemoListData('../pyq2/memos.json'); // 获取自定义列表
      } catch (error) {
        memoList = memoDefaultList
      }
    }
